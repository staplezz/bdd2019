...
Submarca varchar(20) NOT NULL,
CONSTRAINT LlaveP PRIMARY KEY(Submarca)
CONSTRAINT Submarca FOREIGN KEY(Submarca) REFERENCES Automovil1(Submarca)
);

--Comentarios de la tabla Automovil.
COMMENT ON TABLE Automovil2 IS 'Para representar un automóvil';
...
COMMENT ON CONSTRAINT LlaveP ON Automovil2 IS 'La llave primaria representada por la marca del automóvil';
COMMENT ON CONSTRAINT Submarca ON Automovil2 IS 'la llave foránea asociada a la submarca.';
...
Color varchar(20) NOT NULL,
numPuertas smallint,
CONSTRAINT LlaveP PRIMARY KEY(Submarca, Año, Color, numPuertas);
CONSTRAINT PrecioFactura FOREIGN KEY(PrecioFactura) REFERENCES Automovil1(PrecioFactura)
CONSTRAINT Submarca FOREIGN KEY(Submarca) REFERENCES Automovil1(Submarca)
CONSTRAINT Año FOREIGN KEY(Año) REFERENCES Automovil1(Año)
CONSTRAINT Color FOREIGN KEY(Color) REFERENCES Automovil1(Color)
CONSTRAINT numPuertas FOREIGN KEY(numPuertas) REFERENCES Automovil1(numPuertas)
);

--Comentarios de la tabla Automovil.
COMMENT ON TABLE Automovil3 IS 'Para representar un automóvil';
...
COMMENT ON CONSTRAINT LlaveP ON Automovil3 IS 'La llave primaria';
COMMENT ON CONSTRAINT PrecioFactura ON Automovil3 IS 'La llave foránea asociada a el precio de la factura';
COMMENT ON CONSTRAINT Submarca ON Automovil3 IS 'La llave foránea asociada a la submarca';
COMMENT ON CONSTRAINT Año ON Automovil3 IS 'La llave foránea asociada al año';
COMMENT ON CONSTRAINT Color ON Automovil3 IS 'La llave foránea asociada al color';
COMMENT ON CONSTRAINT numPuertas ON Automovil3 IS 'La llave foránea asociada al número de puertas';
